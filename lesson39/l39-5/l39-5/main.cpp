...
Student::Student(char* name, char* surname, int hp, int energy, int iq, int sanity, int excitement):Student(hp, energy, iq, sanity, excitement)
{
...
int main() {
    ...
    cin >> hp >> energy >> iq >> sanity >> excitement;
